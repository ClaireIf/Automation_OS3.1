...
test_ssid = config.get('SSID', 'ssid_english')
...
class Test_get_English_SSID:
    ...
    def test_get_24G_English_SSID(self):
        print(u'初始化设置-获取英文2.4G SSID')
        assert get_24g_newSSID(self.driver) == 1

    def test_get_5G_English_SSID(self):
        print(u'初始化设置-获取英文5G SSID')
